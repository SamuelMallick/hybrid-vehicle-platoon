...
for i in range(len(types)-1):
    ...
    axs[1].fill_between(n_sw, [perf_drop_rel_mean[i][j] - perf_drop_rel_sd[i][j] for j in range(len(n_sw))], [perf_drop_rel_mean[i][j] + perf_drop_rel_sd[i][j] for j in range(len(n_sw))], alpha=0.2)
...
for i in range(len(types)-1):
    ...
    axs[1].fill_between(n_sw, [perf_drop_abs_mean[i][j] - perf_drop_abs_sd[i][j] for j in range(len(n_sw))], [perf_drop_abs_mean[i][j] + perf_drop_abs_sd[i][j] for j in range(len(n_sw))], alpha=0.2)
...
# bounds on axes
ub_perf = max([max([perf_drop_abs_mean[i][j] + perf_drop_abs_sd[i][j] for j in range(len(n_sw))]) for i in range(2 if not multi_lead else 0, len(perf_drop_abs_mean))])
lb_perf = min([min([perf_drop_abs_mean[i][j] - perf_drop_abs_sd[i][j] for j in range(len(n_sw))]) for i in range(len(perf_drop_abs_mean))])
...
for i in range(num_decent_vars):
    axs[1].plot(n_sw, perf_drop_abs_mean[i], mf[i], color=f"C{i}", linewidth=lw, markersize=ms, markerfacecolor="none")
    axs[1].fill_between(n_sw, [perf_drop_abs_mean[i][j] - perf_drop_abs_sd[i][j] for j in range(len(n_sw))], [perf_drop_abs_mean[i][j] + perf_drop_abs_sd[i][j] for j in range(len(n_sw))], alpha=0.2, color=f"C{i}")
...
for i in range(num_decent_vars, num_decent_vars+num_seq_vars):
    axs[2].plot(n_sw, perf_drop_abs_mean[i], mf[i], color=f"C{i}", linewidth=lw, markersize=ms, markerfacecolor="none")
    axs[2].fill_between(n_sw, [perf_drop_abs_mean[i][j] - perf_drop_abs_sd[i][j] for j in range(len(n_sw))], [perf_drop_abs_mean[i][j] + perf_drop_abs_sd[i][j] for j in range(len(n_sw))], alpha=0.2, color=f"C{i}")
...
for i in range(num_decent_vars+num_seq_vars, num_decent_vars+num_seq_vars+num_event_vars):
    axs[3].plot(n_sw, perf_drop_abs_mean[i], mf[i], color=f"C{i}", linewidth=lw, markersize=ms, markerfacecolor="none")
    axs[3].fill_between(n_sw, [perf_drop_abs_mean[i][j] - perf_drop_abs_sd[i][j] for j in range(len(n_sw))], [perf_drop_abs_mean[i][j] + perf_drop_abs_sd[i][j] for j in range(len(n_sw))], alpha=0.2, color=f"C{i}")
...
for i in range(num_decent_vars+num_seq_vars+num_event_vars, num_decent_vars+num_seq_vars+num_event_vars+num_admm_vars):
    axs[4].plot(n_sw, perf_drop_abs_mean[i], mf[i], color=f"C{i}", linewidth=lw, markersize=ms, markerfacecolor="none")
    axs[4].fill_between(n_sw, [perf_drop_abs_mean[i][j] - perf_drop_abs_sd[i][j] for j in range(len(n_sw))], [perf_drop_abs_mean[i][j] + perf_drop_abs_sd[i][j] for j in range(len(n_sw))], alpha=0.2, color=f"C{i}")
